...
import OralGlucose from "../../../../../components/laboratory/forms/chemistry/oral-glucose/OralGlucose";

const OralGlucoseModal = (props, ref) => {
	const {
		register,
		// getValues,
		watch,
...
export default forwardRef(OralGlucoseModal);

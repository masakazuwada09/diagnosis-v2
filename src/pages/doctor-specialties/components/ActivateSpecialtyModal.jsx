...
const ActivateSpecialtyModal = (props, ref) => {
	...
	const submit = (data) => {
		...
		let url = `v1/specialties/activate`;
		if (healthUnit?.id) {
			url = `v1/specialties/activate/${healthUnit?.id}`;
...
export default forwardRef(ActivateSpecialtyModal);

...
const UploadHookWormModal = (props, ref) => {
	...
	const submit = (data) => {
		...
		formdata.append("hookworm", data?.hookworm);
							...
							<Dialog.Panel className="w-full lg:max-w-xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all">
								...
								<div className="p-6 flex flex-col gap-y-4 relative">
									<TextInputField
										...
										errors={errors?.hookworm?.message}
									/>
									{/* <TextAreaField
										label="Remarks"
										placeholder=""
...
export default forwardRef(UploadHookWormModal)

...
const UploadAmylaseModal = (props, ref) => {
	...
	const submit = (data) => {
		...
		formdata.append("amylase", data?.amylase);
						...
						>
							<Dialog.Panel className="w-full lg:max-w-xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all">
								...
								<div className="p-6 flex flex-col gap-y-4 relative">
									<TextInputField
										label="Amylase"
										placeholder="31-107 U/L"
										{...register("amylase", {
											required:
												"The Amylase is required.",
										})}
										errors={errors?.amylase?.message}
									/>
									{/* <TextAreaField
										label="Remarks"
										placeholder=""
...
export default forwardRef(UploadAmylaseModal)

...
import GramsOralGlucose from "../../../../../components/laboratory/forms/chemistry/oral-glucose/GramsOralGlucose";

const GramsOralGlucoseModal = (props, ref) => {
	const {
		register,
		// getValues,
		watch,
...
export default forwardRef(GramsOralGlucoseModal);

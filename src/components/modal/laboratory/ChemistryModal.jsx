...
import ChemistryExam from "../../laboratory/forms/chemistry/ChemistryExam";
import LipidProfile from "../../laboratory/forms/chemistry/LipidProfile";
import HoursUrineCreatinine from "../../laboratory/forms/chemistry/HoursUrineCreatinine";
import Electrolytes from "../../laboratory/forms/chemistry/Electrolytes";
import TotalProtein from "../../laboratory/forms/chemistry/TotalProtein";
import Urea from "../../laboratory/forms/chemistry/Urea";
							...
							<Dialog.Panel className="w-full lg:max-w-xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all">
								...
								<div className="m-2">
									...
									<TotalProtein
										...
										errors={errors}
									/>
									<Urea register={register} errors={errors} />

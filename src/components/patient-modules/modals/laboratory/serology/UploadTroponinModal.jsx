...
const UploadTroponinModal = (props, ref) => {
	...
	const submit = (data) => {
		...
		formdata.append("troponin", data?.troponin);
							...
							<Dialog.Panel className="w-full lg:max-w-xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all">
								...
								<div className="p-6 flex flex-col gap-y-4 relative">
									<TextInputField
										...
										errors={errors?.troponin?.message}
									/>
									{/* <TextAreaField
										label="Remarks"
										placeholder=""
...
export default forwardRef(UploadTroponinModal)

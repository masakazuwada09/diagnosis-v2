...
const UploadChestSpotViewRLLFPortableFeeModal = (props, ref) => {
								...
								<div className="p-6 flex flex-col gap-y-4 relative">
									<div className="border-b">
										<span className="text-xl text-center font-bold  text-blue-500">
                                         CHEST SPOT VIEW RIGHT LOWER LF + PORTABLE FEE
                                            </span>
									</div>
									<Controller
										name="image"
...
export default forwardRef(UploadChestSpotViewRLLFPortableFeeModal)
...
import UrineGlucose from "../../../../../components/laboratory/forms/chemistry/oral-glucose/UrineGlucose";

const UrineGlucoseModal = (props, ref) => {
	const {
		register,
		// getValues,
		watch,
...
export default forwardRef(UrineGlucoseModal);

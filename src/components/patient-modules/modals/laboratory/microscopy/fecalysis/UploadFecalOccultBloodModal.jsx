...
const UploadFecalOccultBloodModal = (props, ref) => {
	...
	const submit = (data) => {
		...
		formdata.append("fecal_occult_blood_fecalysis", data?.fecal_occult_blood_fecalysis);
							...
							<Dialog.Panel className="w-full lg:max-w-xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all">
								...
								<div className="p-6 flex flex-col gap-y-4 relative">
									<TextInputField
										...
										{...register("fecal_occult_blood_fecalysis", {
											required:
												"The Alkaline Phos. is required.",
										})}
										errors={errors?.fecal_occult_blood_fecalysis?.message}
									/>
									{/* <TextAreaField
										label="Remarks"
										placeholder=""
...
export default forwardRef(UploadFecalOccultBloodModal)

...
import RadiographicModal from "../../components/modal/laboratory/RadiographicModal";
...
const Radiology = (props) => {
  ...
  return (
    ...
    <span className="mr-4">RADIOLOGY</span> 
     <ActionBtn
			className="text-base gap-2 !w-[250px] mr-2"
			onClick={() => {
				radiologyRef?.current?.show(patient);
			}}
		>  
			<FlatIcon icon="rr-plus" /> Radiographic Report
		</ActionBtn>
    </div>
    </div>
    <RadiographicModal 

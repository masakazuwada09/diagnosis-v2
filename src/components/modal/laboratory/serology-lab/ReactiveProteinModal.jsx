...
import ReactiveProtein from "../../../../components/laboratory/forms/serology/ReactiveProtein";

const ReactiveProteinModal = (props, ref) => {
	const {
		register,
		// getValues,
		watch,
...
export default forwardRef(ReactiveProteinModal);

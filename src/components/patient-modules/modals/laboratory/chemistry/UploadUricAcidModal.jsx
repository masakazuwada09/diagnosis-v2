...
const UploadUricAcidModal = (props, ref) => {
						...
						>
							<Dialog.Panel className="w-full lg:max-w-xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all">
								...
								<div className="p-6 flex flex-col gap-y-4 relative">
									<TextInputField
										label="Uric Acid"
										placeholder="2.6-7.2mg/dL"
										{...register("uric_acid", {
											required:
												"The Uric Acid is required.",
										})}
										errors={errors?.uric_acid?.message}
									/>
									{/* <TextAreaField
										label="Remarks"
										placeholder=""
...
export default forwardRef(UploadUricAcidModal)

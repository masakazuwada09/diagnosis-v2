...
import CreatinineChem from "../../../../components/laboratory/forms/chemisty-forms/CreatinineChem";
import ActionBtn from "../../../buttons/ActionBtn";

const CreatinineChemModal = (props, ref) => {
	const {
		register,
		// getValues,
		watch,
...
export default forwardRef(CreatinineChemModal);

...
const UploadLDHModal = (props, ref) => {
							...
							<Dialog.Panel className="w-full lg:max-w-xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all">
								...
								>
                                    ...
                                    <span className="text-sm text-center font-bold  text-blue-600 mt-2">
										Lactate dehydrogenase Test Result
									</span>
								</Dialog.Title>
								<div className="p-6 flex flex-col gap-y-4 relative">
									<TextInputField
										label="LDH"
										placeholder="125-220 U/L"
										{...register("ldh", {
											required:
												"The LDH is required.",
										})}
										errors={errors?.ldh?.message}
									/>
									{/* <TextAreaField
										label="Remarks"
										placeholder=""
...
export default forwardRef(UploadLDHModal)

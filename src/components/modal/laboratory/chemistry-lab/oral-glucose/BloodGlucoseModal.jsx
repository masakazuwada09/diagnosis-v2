...
import BloodGlucose from "../../../../../components/laboratory/forms/chemistry/oral-glucose/BloodGlucose";

const BloodGlucoseModal = (props, ref) => {
	const {
		register,
		// getValues,
		watch,
...
export default forwardRef(BloodGlucoseModal);

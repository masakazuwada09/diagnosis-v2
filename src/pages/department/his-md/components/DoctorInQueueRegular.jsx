...
const DoctorInQueueRegular = ({
	...
	return (
		<div
			...
			onClick={onClick}
			>
			<span className="flex items-center justify-center bg-blue-50 border border-teal-700 text-teal-700 tracking-tight rounded-full font-bold w-12 aspect-square">
				#{number}
			</span>

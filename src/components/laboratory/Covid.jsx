...
import CovidTestModal from "../../components/modal/laboratory/CovidTestModal";
...
const Covid = (props) => {
  ...
  return (
    ...
    <span className="mr-4">COVID 19</span>
    <ActionBtn
			className="text-base gap-2 !w-[250px] mr-2"
			onClick={() => {
				covidRef?.current?.show(patient);
			}}
		>  
			<FlatIcon icon="rr-plus" /> Covid 19 Antigen Test
		</ActionBtn>
     </div>
    </div>
    <CovidTestModal 

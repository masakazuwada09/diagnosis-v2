...
const ActivateRoomModal = (props, ref) => {
	...
	const submit = (data) => {
		...
		let url = `v1/operating-rooms/activate`;
		if (room?.id) {
			url = `v1/operating-rooms/activate/${room?.id}`;
...
export default forwardRef(ActivateRoomModal);

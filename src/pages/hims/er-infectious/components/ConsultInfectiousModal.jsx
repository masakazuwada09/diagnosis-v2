...
import InfectiousDetails from "./InfectiousDetails";
import FlatIcon from "../../../../components/FlatIcon";

const ConsultInfectiousModal = (props, ref) => {
	...
	const submit = (data) => {
		...
		Axios.post(
			...
			reset();
			mutateAll();
			toast.success("Infectious accepted successfully!");
			hide();
		});
	};
	return (
							...
							<Dialog.Panel className="w-full lg:max-w-5xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all">
								...
								<div>
									<h4 className="border flex items-center text-base font-bold p-2 mb-0 border-indigo-100 lg:col-span-12">
										<span>Infectious Patient Information</span>
									</h4>
...
export default forwardRef(ConsultInfectiousModal);

...
import SurgeryAssessment from "../../../department/his-surgical/SurgeryAssessment";
import PACUAssessment from "./PACUAssessment";
...
const AppointmentDetailsForPACU = (props) => {
						...
						<div>
								...
								<Fade key={`order-${order?.id}`}>
									<div>
										...
										<div className="flex flex-col lg:flex-row gap-4 items-center   border-b justify-end md:justify-start bg-slate-50 p-1 h-full">

...
const UploadTrichiurisModal = (props, ref) => {
	...
	const submit = (data) => {
		...
		formdata.append("triciuris_trichiura", data?.triciuris_trichiura);
							...
							<Dialog.Panel className="w-full lg:max-w-xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all">
								...
								>
                                    ...
                                    <span className="text-sm text-center font-bold  text-blue-600 mt-2">
										Trichiuris Trichiura Ova Test Result
									</span>
								</Dialog.Title>
								<div className="p-6 flex flex-col gap-y-4 relative">
									<TextInputField
										label="Trichiuris Trichiura Ova"
										placeholder="70-110mg/dL"
										{...register("triciuris_trichiura", {
											required:
												"The Alkaline Phos. is required.",
										})}
										errors={errors?.triciuris_trichiura?.message}
									/>
									{/* <TextAreaField
										label="Remarks"
										placeholder=""
...
export default forwardRef(UploadTrichiurisModal)

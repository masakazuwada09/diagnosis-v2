...
const MedicalCertificateModal = (props, ref) => {
...
const onHematologyChecked = (name) => {
  ...
  <div className="flex items-center relative justify-center  px-2 pt-2">
                                    ...
                                    <h4 className="font-bold text-xl text-gray-600">
										...
										<div className="flex flex-col  p-2 text-sm relative">
                                            ...
                                            <div class="content">
                                                ...
                                                <div className="flex flex-col items-center mt-[80px] ml-[450px]">
                                                {imageSrc && (
	...
	<div className="bg-white  w-[5.4in] gap-y-2 border rounded-md py-2 px-2 shadow-2xl">
...
export default forwardRef(MedicalCertificateModal);

...
import Antistrptolysin from "../../../../components/laboratory/forms/serology/Antistrptolysin";

const AntistrptolysinModal = (props, ref) => {
	const {
		register,
		// getValues,
		watch,
...
export default forwardRef(AntistrptolysinModal);

...
const UploadMacroscopicModal = (props, ref) => {
	...
	const submit = (data) => {
		...
		formdata.append("color_fecalysis", data?.color_fecalysis);
        formdata.append("consistency_fecalysis", data?.consistency_fecalysis);
							...
							<Dialog.Panel className="w-full lg:max-w-xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all">
								...
								>
                                    ...
                                    <span className="text-sm text-center font-bold  text-blue-600 mt-2">
										Macroscopic Examination Test Result
									</span>
								</Dialog.Title>
								<div className="p-6 flex flex-col gap-y-4 relative">
									<TextInputField
										...
										{...register("color_fecalysis", {
											required:
												"The Alkaline Phos. is required.",
										})}
										errors={errors?.color_fecalysis?.message}
									/>
                                    <TextInputField
										label="Consistency"
										placeholder="70-110mg/dL"
										{...register("consistency_fecalysis", {
											required:
												"The Alkaline Phos. is required.",
										})}
										errors={errors?.consistency_fecalysis?.message}
									/>
									{/* <TextAreaField
										label="Remarks"
										placeholder=""
...
export default forwardRef(UploadMacroscopicModal)

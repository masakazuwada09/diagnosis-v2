...
import UploadImagingTest from "./modal/UploadImagingTest";
...
const ImagingResult = (props) => {
    ...
    const { user } = useAuth();
    const imagingResultRef = useRef(null);
    const {
		page,
		setPage,
		meta,
  ...
  return (
   ...
   <div className="flex flex-col items-start">
    ...
    onClick={() => {
	imagingResultRef.current.show();
	}}
    >
        <FlatIcon icon="rr-add" /> Upload Imaging
    </ActionBtn> 
    <Table
				className={`pb-2`}
				loading={loading}

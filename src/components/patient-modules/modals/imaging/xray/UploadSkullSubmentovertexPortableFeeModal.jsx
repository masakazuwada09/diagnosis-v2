...
const UploadSkullSubmentovertexPortableFeeModal = (props, ref) => {
			...
			<Dialog as="div" className="" onClose={noHide}>
				...
				<div className="fixed inset-0 overflow-y-auto !z-[350]">
					<div className="flex min-h-full items-center justify-center p-4 text-center">
                        ...
                        SKULL SUBMENTOVERTEX + PORTABLE FEE
                                            </span>
									</div>
									<Controllerr
										name="image"
...
export default forwardRef(UploadSkullSubmentovertexPortableFeeModal)
...
const UploadAlkalinePhosModal = (props, ref) => {
	...
	const submit = (data) => {
		...
		formdata.append("alkaline_phos", data?.alkaline_phos);
							...
							<Dialog.Panel className="w-full lg:max-w-xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all">
								...
								<div className="p-6 flex flex-col gap-y-4 relative">
									<TextInputField
										...
										errors={errors?.alkaline_phos?.message}
									/>
									{/* <TextAreaField
										label="Remarks"
										placeholder=""
...
export default forwardRef(UploadAlkalinePhosModal)

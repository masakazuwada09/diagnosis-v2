...
const UploadGGTModal = (props, ref) => {
							...
							<Dialog.Panel className="w-full lg:max-w-xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all">
								...
								>
                                    ...
                                    <span className="text-sm text-center font-bold  text-blue-600 mt-2">
										Gamma-glutamyl transferase Test Result
									</span>
								</Dialog.Title>
								<div className="p-6 flex flex-col gap-y-4 relative">
									<TextInputField
										label="GGT"
										placeholder="M:10-71 U/L F:6-42 U/L"
										{...register("ggt", {
											required:
												"The GGT is required.",
										})}
										errors={errors?.ggt?.message}
									/>
									{/* <TextAreaField
										label="Remarks"
										placeholder=""
...
export default forwardRef(UploadGGTModal)

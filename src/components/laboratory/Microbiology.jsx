...
import MicrobiologyModal from "../../components/modal/laboratory/MicrobiologyModal";
...
const Microbiology = (props) => {
  ...
  return (
    ...
    <span className="mr-4">MICTOBIOLOGY</span> 
   <ActionBtn
			className="text-base gap-2 !w-[250px] mr-2"
			onClick={() => {
				microbiologyRef?.current?.show(patient);
			}}
		>
			<FlatIcon icon="rr-plus" /> Microbiology Examination
		</ActionBtn>
    </div>
    </div>
    <MicrobiologyModal 
    ...
    <div className="flex items-start justify-start flex-wrap gap-3 mb-3 w-full px-0">
      <Card
      color="red"
      title="Culture And Sensitivity Final Result"
      icon="result"
      >
      </Card>
      <Card

...
import HematologyExam from "../../../components/laboratory/forms/hematology/HematologyExam";
			...
			<Dialog as="div" className="relative z-10" onClose={hide}>
				...
				<div className="fixed inset-0 overflow-y-auto">
					<div className="flex max-h-auto item-center justify-center p-4 text-center">
						...
						>
							<Dialog.Panel className="w-auto lg:max-w-2xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all">
								<Dialog.Title
									as="div"

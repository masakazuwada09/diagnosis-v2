...
const UploadMicroscopicModal = (props, ref) => {
	...
	const submit = (data) => {
		...
		formdata.append("rbc_fecalysis", data?.rbc_fecalysis);
        formdata.append("wbc_fecalysis", data?.wbc_fecalysis);
        formdata.append("fat_globules_fecalysis", data?.fat_globules_fecalysis);
        formdata.append("yeast_cells_fecalysis", data?.yeast_cells_fecalysis);
							...
							<Dialog.Panel className="w-full lg:max-w-xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all">
								...
								<div className="p-6 flex flex-col gap-y-4 relative">
									<TextInputField
										...
										{...register("rbc_fecalysis", {
											required:
												"The Alkaline Phos. is required.",
										})}
										errors={errors?.rbc_fecalysis?.message}
									/>
                                    <TextInputField
										label="WBC"
										placeholder="70-110mg/dL"
										{...register("wbc_fecalysis", {
											required:
												"The Alkaline Phos. is required.",
										})}
										errors={errors?.wbc_fecalysis?.message}
									/>
                                    <TextInputField
										label="Fat Globules"
										placeholder="70-110mg/dL"
										{...register("fat_globules_fecalysis", {
											required:
												"The Alkaline Phos. is required.",
										})}
										errors={errors?.fat_globules_fecalysis?.message}
									/>
                                    <TextInputField
										label="Yeast Cells"
										placeholder="70-110mg/dL"
										{...register("yeast_cells_fecalysis", {
											required:
												"The Alkaline Phos. is required.",
										})}
										errors={errors?.yeast_cells_fecalysis?.message}
									/>
									{/* <TextAreaField
										label="Remarks"
										placeholder=""
...
export default forwardRef(UploadMicroscopicModal)

...
const UploadPhosphurosModal = (props, ref) => {
	...
	const submit = (data) => {
		...
		formdata.append("phophorus", data?.phophorus);
						...
						>
							<Dialog.Panel className="w-full lg:max-w-xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all">
								...
								<div className="p-6 flex flex-col gap-y-4 relative">
									<TextInputField
										label="Phophorus"
										placeholder="2.5-4.5 mg/dL"
										{...register("phophorus", {
											required:
												"The Phophorus is required.",
										})}
										errors={errors?.phophorus?.message}
									/>
									{/* <TextAreaField
										label="Remarks"
										placeholder=""
...
export default forwardRef(UploadPhosphurosModal)
